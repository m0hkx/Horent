    ...
    return (
        <>
            <div className="grid grid-cols-12 grid-rows-14 gap-[12px] px-[5vw] py-[1vw] w-full h-full">
                ...
                <div className="bg-[#FFFFFF] 2xl:row-start-3 2xl:row-span-4 xl:row-start-3 xl:row-span-3 md:row-start-3 md:row-span-3 sm:row-start-3 sm:row-span-2 col-start-7 col-span-3 rounded-[40px] drop-shadow-[0_0_2px_rgba(0,0,0,0.25)] flex flex-col justify-between">
                    <div className="flex items-center 2xl:py-5 2xl:px-10 xl:py-3 xl:px-5 xl:justify-center md:py-3 md:px-5 md:justify-center sm:py-2 sm:px-3 sm:justify-center">
                        <div className="bg-[#EFEFEF] rounded-full w-[3vw] h-[3vw] flex items-center justify-center mr-5">
                            <BanknoteArrowUp className="w-[1.9vw] h-[1.9vw]" />
                        </div>

                        <p className="2xl:text-2xl xl:text-lg lg:text-md md:text-sm sm:text-xs" style={{ fontFamily: 'Lufga', fontWeight: 500 }}>Total Revenue</p>
                    </div>

                    <div className="flex items-center justify-center mb-6">
                        <p className="2xl:text-3xl xl:text-xl lg:text-lg md:text-md sm:text-sm mr-7" style={{ fontFamily: 'Lufga', fontWeight: 600 }}>$32,125.00</p>
                ...
                <div className="bg-[#FFFFFF] 2xl:row-start-3 2xl:row-span-4 xl:row-start-3 xl:row-span-3 md:row-start-3 md:row-span-3 sm:row-start-3 sm:row-span-2 col-start-10 col-span-3 rounded-[40px] drop-shadow-[0_0_2px_rgba(0,0,0,0.25)] flex flex-col justify-between">
                    <div className="flex items-center 2xl:py-5 2xl:px-10 xl:py-3 xl:px-5 xl:justify-center md:py-3 md:px-5 md:justify-center sm:py-2 sm:px-3 sm:justify-center">
                        <div className="bg-[#EFEFEF] rounded-full w-[3vw] h-[3vw] flex items-center justify-center mr-5">
                            <BanknoteArrowDown className="w-[1.9vw] h-[1.9vw]" />
                        </div>

                        <p className="2xl:text-2xl xl:text-lg lg:text-md md:text-sm sm:text-xs" style={{ fontFamily: 'Lufga', fontWeight: 500 }}>Total Expanses</p>
                    </div>

                    <div className="flex items-center justify-center mb-6">
                        <p className="2xl:text-3xl xl:text-xl lg:text-lg md:text-md sm:text-sm mr-7" style={{ fontFamily: 'Lufga', fontWeight: 600 }}>$16,650.00</p>
