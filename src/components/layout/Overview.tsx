    ...
    return (
        <>
            <div className="grid grid-cols-12 grid-rows-14 gap-[12px] px-[5vw] py-[1vw] w-full h-full">
                <Topbar />
                <h1 className="row-start-2 col-span-8 self-end-safe text-md sm:text-xl sm:col-span-8 md:text-2xl md:col-span-5 lg:text-3xl lg:col-span-4 xl:text-4xl" style={{ fontFamily: 'Lufga', fontWeight: 600 }}>
                    Real Estate
                </h1>
